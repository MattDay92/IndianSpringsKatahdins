 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pv(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function Xh(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(pv())}function mv(){const t=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof t=="object"&&t.id!==void 0}function gv(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function Zh(){return qh.NODE_ADMIN===!0}function ef(){try{return typeof indexedDB=="object"}catch{return!1}}function tf(){return new Promise((t,e)=>{try{let n=!0;const s="validate-browser-context-for-indexeddb-analytics-module",i=self.indexedDB.open(s);i.onsuccess=()=>{i.result.close(),n||self.indexedDB.deleteDatabase(s),t(!0)},i.onupgradeneeded=()=>{n=!1},i.onerror=()=>{var r;e(((r=i.error)===null||r===void 0?void 0:r.message)||"")}}catch(n){e(n)}})}function _v(){return!(typeof navigator>"u"||!navigator.cookieEnabled)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nf=function(t){let e={},n={},s={},i="";try{const r=t.split(".");e=$s(No(r[0])||""),n=$s(No(r[1])||""),i=r[2],s=n.d||{},delete n.d}catch{}return{header:e,claims:n,data:s,signature:i}},wv=function(t){const e=nf(t),n=e.claims;return!!n&&typeof n=="object"&&n.hasOwnProperty("iat")},Ev=function(t){const e=nf(t).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tv=1e3,Rv=2,Av=4*60*60*1e3,xv=.5;function fc(t,e=Tv,n=Rv){const s=e*Math.pow(n,t),i=Math.round(xv*s*(Math.random()-.5)*2);return Math.min(Av,s+i)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tb=wb;function of(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const s=Object.assign({name:Mo,automaticDataCollectionEnabled:!1},e),i=s.name;if(typeof i!="string"||!i)throw Kt.create("bad-app-name",{appName:String(i)});if(n||(n=Jh()),!n)throw Kt.create("no-options");const r=Fi.get(i);if(r){if(Li(n,r.options)&&Li(s,r.config))return r;throw Kt.create("duplicate-app",{appName:i})}const o=new kv(i);for(const l of Lo.values())o.addComponent(l);const a=new Sb(n,s,o);return Fi.set(i,a),a}function af(t=Mo){const e=Fi.get(t);if(!e&&t===Mo&&Jh())return of();if(!e)throw Kt.create("no-app",{appName:t});return e}function _t(t,e,n){var s;let i=(s=Eb[t])!==null&&s!==void 0?s:t;n&&(i+=`-${n}`);const r=i.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const a=[`Unable to register library "${i}" with version "${e}":`];r&&a.push(`library name "${i}" contains illegal characters (whitespace or "/")`),r&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),xn.warn(a.join(" "));return}nn(new At(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rb="firebase-heartbeat-database",Ab=1,Bs="firebase-heartbeat-store";let Hr=null;function lf(){return Hr||(Hr=qv(Rb,Ab,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(Bs)}catch(n){console.warn(n)}}}}).catch(t=>{throw Kt.create("idb-open",{originalErrorMessage:t.message})})),Hr}async function xb(t){try{return await(await lf()).transaction(Bs).objectStore(Bs).get(cf(t))}catch(e){if(e instanceof Mn)xn.warn(e.message);else{const n=Kt.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});xn.warn(n.message)}}}async function _c(t,e){try{const s=(await lf()).transaction(Bs,"readwrite");await s.objectStore(Bs).put(e,cf(t)),await s.done}catch(n){if(n instanceof Mn)xn.warn(n.message);else{const s=Kt.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});xn.warn(s.message)}}}function cf(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hf=function(t){try{if(typeof window<"u"&&typeof window[t]<"u"){const e=window[t];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new Fb(e)}}catch{}return new $b},mn=hf("localStorage"),Fo=hf("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ra="5",gf="v",_f="s",yf="r",vf="f",bf=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,wf="ls",Ef="p",Bo="ac",Cf="websocket",If="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sc="start",sw="close",iw="pLPCommand",rw="pRTLPCB",Rf="id",Af="pw",xf="ser",ow="cb",aw="seg",lw="ts",cw="d",uw="dframe",Pf=1870,Nf=30,hw=Pf-Nf,fw=25e3,dw=3e4;class Hn{constructor(e,n,s,i,r,o,a){this.connId=e,this.repoInfo=n,this.applicationId=s,this.appCheckToken=i,this.authToken=r,this.transportSessionId=o,this.lastSessionId=a,this.bytesSent=0,this.bytesReceived=0,this.everConnected_=!1,this.log_=si(e),this.stats_=Aa(n),this.urlFn=l=>(this.appCheckToken&&(l[Bo]=this.appCheckToken),Tf(n,If,l))}open(e,n){this.curSegmentNum=0,this.onDisconnect_=n,this.myPacketOrderer=new nw(e),this.isClosed_=!1,this.connectTimeoutTimer_=setTimeout(()=>{this.log_("Timed out trying to connect."),this.onClosed_(),this.connectTimeoutTimer_=null},Math.floor(dw)),Vb(()=>{if(this.isClosed_)return;this.scriptTagHolder=new xa((...r)=>{const[o,a,l,c,h]=r;if(this.incrementIncomingBytes_(r),!!this.scriptTagHolder)if(this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null),this.everConnected_=!0,o===Sc)this.id=a,this.password=l;else if(o===sw)a?(this.scriptTagHolder.sendNewPolls=!1,this.myPacketOrderer.closeAfter(a,()=>{this.onClosed_()})):this.onClosed_();else throw new Error("Unrecognized command received: "+o)},(...r)=>{const[o,a]=r;this.incrementIncomingBytes_(r),this.myPacketOrderer.handleResponse(o,a)},()=>{this.onClosed_()},this.urlFn);const s={};s[Sc]="t",s[xf]=Math.floor(Math.random()*1e8),this.scriptTagHolder.uniqueCallbackIdentifier&&(s[ow]=this.scriptTagHolder.uniqueCallbackIdentifier),s[gf]=Ra,this.transportSessionId&&(s[_f]=this.transportSessionId),this.lastSessionId&&(s[wf]=this.lastSessionId),this.applicationId&&(s[Ef]=this.applicationId),this.appCheckToken&&(s[Bo]=this.appCheckToken),typeof location<"u"&&location.hostname&&bf.test(location.hostname)&&(s[yf]=vf);const i=this.urlFn(s);this.log_("Connecting via long-poll to "+i),this.scriptTagHolder.addTag(i,()=>{})})}start(){this.scriptTagHolder.startLongPoll(this.id,this.password),this.addDisconnectPingFrame(this.id,this.password)}static forceAllow(){Hn.forceAllow_=!0}static forceDisallow(){Hn.forceDisallow_=!0}static isAvailable(){return Hn.forceAllow_?!0:!Hn.forceDisallow_&&typeof document<"u"&&document.createElement!=null&&!Wb()&&!Gb()}markConnectionHealthy(){}shutdown_(){this.isClosed_=!0,this.scriptTagHolder&&(this.scriptTagHolder.close(),this.scriptTagHolder=null),this.myDisconnFrame&&(document.body.removeChild(this.myDisconnFrame),this.myDisconnFrame=null),this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null)}onClosed_(){this.isClosed_||(this.log_("Longpoll is closing itself"),this.shutdown_(),this.onDisconnect_&&(this.onDisconnect_(this.everConnected_),this.onDisconnect_=null))}close(){this.isClosed_||(this.log_("Longpoll is being closed."),this.shutdown_())}send(e){const n=ye(e);this.bytesSent+=n.length,this.stats_.incrementCounter("bytes_sent",n.length);const s=zh(n),i=pf(s,hw);for(let r=0;r<i.length;r++)this.scriptTagHolder.enqueueSegment(this.curSegmentNum,i.length,i[r]),this.curSegmentNum++}addDisconnectPingFrame(e,n){this.myDisconnFrame=document.createElement("iframe");const s={};s[uw]="t",s[Rf]=e,s[Af]=n,this.myDisconnFrame.src=this.urlFn(s),this.myDisconnFrame.style.display="none",document.body.appendChild(this.myDisconnFrame)}incrementIncomingBytes_(e){const n=ye(e).length;this.bytesReceived+=n,this.stats_.incrementCounter("bytes_received",n)}}class xa{constructor(e,n,s,i){this.onDisconnect=s,this.urlFn=i,this.outstandingRequests=new Set,this.pendingSegs=[],this.currentSerial=Math.floor(Math.random()*1e8),this.sendNewPolls=!0;{this.uniqueCallbackIdentifier=Bb(),window[iw+this.uniqueCallbackIdentifier]=e,window[rw+this.uniqueCallbackIdentifier]=n,this.myIFrame=xa.createIFrame_();let r="";this.myIFrame.src&&this.myIFrame.src.substr(0,11)==="javascript:"&&(r='<script>document.domain="'+document.domain+'";<\/script>');const o="<html><body>"+r+"</body></html>";try{this.myIFrame.doc.open(),this.myIFrame.doc.write(o),this.myIFrame.doc.close()}catch(a){Pe("frame writing exception"),a.stack&&Pe(a.stack),Pe(a)}}}static createIFrame_(){const e=document.createElement("iframe");if(e.style.display="none",document.body){document.body.appendChild(e);try{e.contentWindow.document||Pe("No IE domain setting required")}catch{const s=document.domain;e.src="javascript:void((function(){document.open();document.domain='"+s+"';document.close();})())"}}else throw"Document body has not initialized. Wait to initialize Firebase until after the document is ready.";return e.contentDocument?e.doc=e.contentDocument:e.contentWindow?e.doc=e.contentWindow.document:e.document&&(e.doc=e.document),e}close(){this.alive=!1,this.myIFrame&&(this.myIFrame.doc.body.textContent="",setTimeout(()=>{this.myIFrame!==null&&(document.body.removeChild(this.myIFrame),this.myIFrame=null)},Math.floor(0)));const e=this.onDisconnect;e&&(this.onDisconnect=null,e())}startLongPoll(e,n){for(this.myID=e,this.myPW=n,this.alive=!0;this.newRequest_(););}newRequest_(){if(this.alive&&this.sendNewPolls&&this.outstandingRequests.size<(this.pendingSegs.length>0?2:1)){this.currentSerial++;const e={};e[Rf]=this.myID,e[Af]=this.myPW,e[xf]=this.currentSerial;let n=this.urlFn(e),s="",i=0;for(;this.pendingSegs.length>0&&this.pendingSegs[0].d.length+Nf+s.length<=Pf;){const o=this.pendingSegs.shift();s=s+"&"+aw+i+"="+o.seg+"&"+lw+i+"="+o.ts+"&"+cw+i+"="+o.d,i++}return n=n+s,this.addLongPollTag_(n,this.currentSerial),!0}else return!1}enqueueSegment(e,n,s){this.pendingSegs.push({seg:e,ts:n,d:s}),this.alive&&this.newRequest_()}addLongPollTag_(e,n){this.outstandingRequests.add(n);const s=()=>{this.outstandingRequests.delete(n),this.newRequest_()},i=setTimeout(s,Math.floor(fw)),r=()=>{clearTimeout(i),s()};this.addTag(e,r)}addTag(e,n){setTimeout(()=>{try{if(!this.sendNewPolls)return;const s=this.myIFrame.doc.createElement("script");s.type="text/javascript",s.async=!0,s.src=e,s.onload=s.onreadystatechange=function(){const i=s.readyState;(!i||i==="loaded"||i==="complete")&&(s.onload=s.onreadystatechange=null,s.parentNode&&s.parentNode.removeChild(s),n())},s.onerror=()=>{Pe("Long-poll script failed to load: "+e),this.sendNewPolls=!1,this.close()},this.myIFrame.doc.body.appendChild(s)}catch{}},Math.floor(1))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kf{constructor(e){this.allowedEvents_=e,this.listeners_={},I(Array.isArray(e)&&e.length>0,"Requires a non-empty array")}trigger(e,...n){if(Array.isArray(this.listeners_[e])){const s=[...this.listeners_[e]];for(let i=0;i<s.length;i++)s[i].callback.apply(s[i].context,n)}}on(e,n,s){this.validateEventType_(e),this.listeners_[e]=this.listeners_[e]||[],this.listeners_[e].push({callback:n,context:s});const i=this.getInitialEvent(e);i&&n.apply(s,i)}off(e,n,s){this.validateEventType_(e);const i=this.listeners_[e]||[];for(let r=0;r<i.length;r++)if(i[r].callback===n&&(!s||s===i[r].context)){i.splice(r,1);return}}validateEventType_(e){I(this.allowedEvents_.find(n=>n===e),"Unknown event: "+e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bi extends kf{constructor(){super(["online"]),this.online_=!0,typeof window<"u"&&typeof window.addEventListener<"u"&&!Xh()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}static getInstance(){return new Bi}getInitialEvent(e){return I(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Oc=32,kc=768;class le{constructor(e,n){if(n===void 0){this.pieces_=e.split("/");let s=0;for(let i=0;i<this.pieces_.length;i++)this.pieces_[i].length>0&&(this.pieces_[s]=this.pieces_[i],s++);this.pieces_.length=s,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=n}toString(){let e="";for(let n=this.pieceNum_;n<this.pieces_.length;n++)this.pieces_[n]!==""&&(e+="/"+this.pieces_[n]);return e||"/"}}function ne(){return new le("")}function ee(t){return t.pieceNum_>=t.pieces_.length?null:t.pieces_[t.pieceNum_]}function sn(t){return t.pieces_.length-t.pieceNum_}function ue(t){let e=t.pieceNum_;return e<t.pieces_.length&&e++,new le(t.pieces_,e)}function Df(t){return t.pieceNum_<t.pieces_.length?t.pieces_[t.pieces_.length-1]:null}function Iw(t){let e="";for(let n=t.pieceNum_;n<t.pieces_.length;n++)t.pieces_[n]!==""&&(e+="/"+encodeURIComponent(String(t.pieces_[n])));return e||"/"}function Mf(t,e=0){return t.pieces_.slice(t.pieceNum_+e)}function Lf(t){if(t.pieceNum_>=t.pieces_.length)return null;const e=[];for(let n=t.pieceNum_;n<t.pieces_.length-1;n++)e.push(t.pieces_[n]);return new le(e,0)}function ve(t,e){const n=[];for(let s=t.pieceNum_;s<t.pieces_.length;s++)n.push(t.pieces_[s]);if(e instanceof le)for(let s=e.pieceNum_;s<e.pieces_.length;s++)n.push(e.pieces_[s]);else{const s=e.split("/");for(let i=0;i<s.length;i++)s[i].length>0&&n.push(s[i])}return new le(n,0)}function X(t){return t.pieceNum_>=t.pieces_.length}function Le(t,e){const n=ee(t),s=ee(e);if(n===null)return e;if(n===s)return Le(ue(t),ue(e));throw new Error("INTERNAL ERROR: innerPath ("+e+") is not within outerPath ("+t+")")}function Ff(t,e){if(sn(t)!==sn(e))return!1;for(let n=t.pieceNum_,s=e.pieceNum_;n<=t.pieces_.length;n++,s++)if(t.pieces_[n]!==e.pieces_[s])return!1;return!0}function ot(t,e){let n=t.pieceNum_,s=e.pieceNum_;if(sn(t)>sn(e))return!1;for(;n<t.pieces_.length;){if(t.pieces_[n]!==e.pieces_[s])return!1;++n,++s}return!0}class Sw{constructor(e,n){this.errorPrefix_=n,this.parts_=Mf(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let s=0;s<this.parts_.length;s++)this.byteLength_+=gr(this.parts_[s]);$f(this)}}function Tw(t,e){t.parts_.length>0&&(t.byteLength_+=1),t.parts_.push(e),t.byteLength_+=gr(e),$f(t)}function Rw(t){const e=t.parts_.pop();t.byteLength_-=gr(e),t.parts_.length>0&&(t.byteLength_-=1)}function $f(t){if(t.byteLength_>kc)throw new Error(t.errorPrefix_+"has a key path longer than "+kc+" bytes ("+t.byteLength_+").");if(t.parts_.length>Oc)throw new Error(t.errorPrefix_+"path specified exceeds the maximum depth that can be written ("+Oc+") or object contains a cycle "+pn(t))}function pn(t){return t.parts_.length===0?"":"in property '"+t.parts_.join(".")+"'"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pa extends kf{constructor(){super(["visible"]);let e,n;typeof document<"u"&&typeof document.addEventListener<"u"&&(typeof document.hidden<"u"?(n="visibilitychange",e="hidden"):typeof document.mozHidden<"u"?(n="mozvisibilitychange",e="mozHidden"):typeof document.msHidden<"u"?(n="msvisibilitychange",e="msHidden"):typeof document.webkitHidden<"u"&&(n="webkitvisibilitychange",e="webkitHidden")),this.visible_=!0,n&&document.addEventListener(n,()=>{const s=!document[e];s!==this.visible_&&(this.visible_=s,this.trigger("visible",s))},!1)}static getInstance(){return new Pa}getInitialEvent(e){return I(e==="visible","Unknown event type: "+e),[this.visible_]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let _i;class Bf extends _r{static get __EMPTY_NODE(){return _i}static set __EMPTY_NODE(e){_i=e}compare(e,n){return is(e.name,n.name)}isDefinedOn(e){throw ss("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,n){return!1}minPost(){return Q.MIN}maxPost(){return new Q(Pn,_i)}makePost(e,n){return I(typeof e=="string","KeyIndex indexValue must always be a string."),new Q(e,_i)}toString(){return".key"}}const zn=new Bf;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Uo;function Dw(t){Uo=t}const Uf=function(t){return typeof t=="number"?"number:"+mf(t):"string:"+t},jf=function(t){if(t.isLeafNode()){const e=t.val();I(typeof e=="string"||typeof e=="number"||typeof e=="object"&&Ot(e,".sv"),"Priority must be a string or number.")}else I(t===Uo||t.isEmpty(),"priority of unexpected type.");I(t===Uo||t.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Vf,Hf;function Mw(t){Vf=t}function Lw(t){Hf=t}class Fw extends _r{compare(e,n){const s=e.node.getPriority(),i=n.node.getPriority(),r=s.compareTo(i);return r===0?is(e.name,n.name):r}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,n){return!e.getPriority().equals(n.getPriority())}minPost(){return Q.MIN}maxPost(){return new Q(Pn,new Ee("[PRIORITY-POST]",Hf))}makePost(e,n){const s=Vf(e);return new Q(n,new Ee("[PRIORITY-POST]",s))}toString(){return".priority"}}const pe=new Fw;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wf(t){return{type:"value",snapshotNode:t}}function Zn(t,e){return{type:"child_added",snapshotNode:e,childName:t}}function js(t,e){return{type:"child_removed",snapshotNode:e,childName:t}}function Vs(t,e,n){return{type:"child_changed",snapshotNode:e,childName:t,oldSnap:n}}function Gw(t,e){return{type:"child_moved",snapshotNode:e,childName:t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vi(){return{value:null,children:new Map}}function Gf(t,e,n){if(X(e))t.value=n,t.children.clear();else if(t.value!==null)t.value=t.value.updateChild(e,n);else{const s=ee(e);t.children.has(s)||t.children.set(s,Vi());const i=t.children.get(s);e=ue(e),Gf(i,e,n)}}function jo(t,e,n){t.value!==null?n(e,t.value):Yw(t,(s,i)=>{const r=new le(e.toString()+"/"+s);jo(i,r,n)})}function Yw(t,e){t.children.forEach((n,s)=>{e(s,n)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var at;(function(t){t[t.OVERWRITE=0]="OVERWRITE",t[t.MERGE=1]="MERGE",t[t.ACK_USER_WRITE=2]="ACK_USER_WRITE",t[t.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"})(at||(at={}));function qf(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function Da(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function Ma(t){return{fromUser:!1,fromServer:!0,queryId:t,tagged:!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hi{constructor(e,n,s){this.path=e,this.affectedTree=n,this.revert=s,this.type=at.ACK_USER_WRITE,this.source=qf()}operationForChild(e){if(X(this.path)){if(this.affectedTree.value!=null)return I(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const n=this.affectedTree.subtree(new le(e));return new Hi(ne(),n,this.revert)}}else return I(ee(this.path)===e,"operationForChild called for unrelated child."),new Hi(ue(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yr(t,e){return{eventCache:t,serverCache:e}}function Rs(t,e,n,s){return yr(new rn(e,n,s),t.serverCache)}function Kf(t,e,n,s){return yr(t.eventCache,new rn(e,n,s))}function Wi(t){return t.eventCache.isFullyInitialized()?t.eventCache.getNode():null}function On(t){return t.serverCache.isFullyInitialized()?t.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vr(t,e){return Xf(e,t)}function rE(t,e,n,s,i){I(s>t.lastWriteId,"Stacking an older write on top of newer ones"),i===void 0&&(i=!0),t.allWrites.push({path:e,snap:n,writeId:s,visible:i}),i&&(t.visibleWrites=As(t.visibleWrites,e,n)),t.lastWriteId=s}function oE(t,e){for(let n=0;n<t.allWrites.length;n++){const s=t.allWrites[n];if(s.writeId===e)return s}return null}function aE(t,e){const n=t.allWrites.findIndex(a=>a.writeId===e);I(n>=0,"removeWrite called with nonexistent writeId.");const s=t.allWrites[n];t.allWrites.splice(n,1);let i=s.visible,r=!1,o=t.allWrites.length-1;for(;i&&o>=0;){const a=t.allWrites[o];a.visible&&(o>=n&&lE(a,s.path)?i=!1:ot(s.path,a.path)&&(r=!0)),o--}if(i){if(r)return cE(t),!0;if(s.snap)t.visibleWrites=jc(t.visibleWrites,s.path);else{const a=s.children;He(a,l=>{t.visibleWrites=jc(t.visibleWrites,ve(s.path,l))})}return!0}else return!1}function lE(t,e){if(t.snap)return ot(t.path,e);for(const n in t.children)if(t.children.hasOwnProperty(n)&&ot(ve(t.path,n),e))return!0;return!1}function cE(t){t.visibleWrites=Yf(t.allWrites,uE,ne()),t.allWrites.length>0?t.lastWriteId=t.allWrites[t.allWrites.length-1].writeId:t.lastWriteId=-1}function uE(t){return t.visible}function Yf(t,e,n){let s=ct.empty();for(let i=0;i<t.length;++i){const r=t[i];if(e(r)){const o=r.path;let a;if(r.snap)ot(n,o)?(a=Le(n,o),s=As(s,a,r.snap)):ot(o,n)&&(a=Le(o,n),s=As(s,ne(),r.snap.getChild(a)));else if(r.children){if(ot(n,o))a=Le(n,o),s=Uc(s,a,r.children);else if(ot(o,n))if(a=Le(o,n),X(a))s=Uc(s,ne(),r.children);else{const l=Jn(r.children,ee(a));if(l){const c=l.getChild(ue(a));s=As(s,ne(),c)}}}else throw ss("WriteRecord should have .snap or .children")}}return s}function Qf(t,e,n,s,i){if(!s&&!i){const r=Ln(t.visibleWrites,e);if(r!=null)return r;{const o=zt(t.visibleWrites,e);if(Ho(o))return n;if(n==null&&!Vo(o,ne()))return null;{const a=n||U.EMPTY_NODE;return es(o,a)}}}else{const r=zt(t.visibleWrites,e);if(!i&&Ho(r))return n;if(!i&&n==null&&!Vo(r,ne()))return null;{const o=function(c){return(c.visible||i)&&(!s||!~s.indexOf(c.writeId))&&(ot(c.path,e)||ot(e,c.path))},a=Yf(t.allWrites,o,e),l=n||U.EMPTY_NODE;return es(a,l)}}}function hE(t,e,n){let s=U.EMPTY_NODE;const i=Ln(t.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(pe,(r,o)=>{s=s.updateImmediateChild(r,o)}),s;if(n){const r=zt(t.visibleWrites,e);return n.forEachChild(pe,(o,a)=>{const l=es(zt(r,new le(o)),a);s=s.updateImmediateChild(o,l)}),Vc(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}else{const r=zt(t.visibleWrites,e);return Vc(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}}function fE(t,e,n,s,i){I(s||i,"Either existingEventSnap or existingServerSnap must exist");const r=ve(e,n);if(Vo(t.visibleWrites,r))return null;{const o=zt(t.visibleWrites,r);return Ho(o)?i.getChild(n):es(o,i.getChild(n))}}function dE(t,e,n,s){const i=ve(e,n),r=Ln(t.visibleWrites,i);if(r!=null)return r;if(s.isCompleteForChild(n)){const o=zt(t.visibleWrites,i);return es(o,s.getNode().getImmediateChild(n))}else return null}function pE(t,e){return Ln(t.visibleWrites,e)}function mE(t,e,n,s,i,r,o){let a;const l=zt(t.visibleWrites,e),c=Ln(l,ne());if(c!=null)a=c;else if(n!=null)a=es(l,n);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const h=[],u=o.getCompare(),f=r?a.getReverseIteratorFrom(s,o):a.getIteratorFrom(s,o);let m=f.getNext();for(;m&&h.length<i;)u(m,s)!==0&&h.push(m),m=f.getNext();return h}else return[]}function gE(){return{visibleWrites:ct.empty(),allWrites:[],lastWriteId:-1}}function Gi(t,e,n,s){return Qf(t.writeTree,t.treePath,e,n,s)}function La(t,e){return hE(t.writeTree,t.treePath,e)}function Hc(t,e,n,s){return fE(t.writeTree,t.treePath,e,n,s)}function qi(t,e){return pE(t.writeTree,ve(t.treePath,e))}function _E(t,e,n,s,i,r){return mE(t.writeTree,t.treePath,e,n,s,i,r)}function Fa(t,e,n){return dE(t.writeTree,t.treePath,e,n)}function Jf(t,e){return Xf(ve(t.treePath,e),t.writeTree)}function Xf(t,e){return{treePath:t,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let zi;class nd{constructor(){this.views=new Map}}function DE(t){I(!zi,"__referenceConstructor has already been defined"),zi=t}function ME(){return I(zi,"Reference.ts has not been loaded"),zi}function LE(t){return t.views.size===0}function Ba(t,e,n,s){const i=e.source.queryId;if(i!==null){const r=t.views.get(i);return I(r!=null,"SyncTree gave us an op for an invalid query."),zc(r,e,n,s)}else{let r=[];for(const o of t.views.values())r=r.concat(zc(o,e,n,s));return r}}function sd(t,e,n,s,i){const r=e._queryIdentifier,o=t.views.get(r);if(!o){let a=Gi(n,i?s:null),l=!1;a?l=!0:s instanceof U?(a=La(n,s),l=!1):(a=U.EMPTY_NODE,l=!1);const c=yr(new rn(a,l,!1),new rn(s,i,!1));return new AE(e,c)}return o}function FE(t,e,n,s,i,r){const o=sd(t,e,s,i,r);return t.views.has(e._queryIdentifier)||t.views.set(e._queryIdentifier,o),OE(o,n),kE(o,n)}function $E(t,e,n,s){const i=e._queryIdentifier,r=[];let o=[];const a=on(t);if(i==="default")for(const[l,c]of t.views.entries())o=o.concat(Kc(c,n,s)),qc(c)&&(t.views.delete(l),c.query._queryParams.loadsAllData()||r.push(c.query));else{const l=t.views.get(i);l&&(o=o.concat(Kc(l,n,s)),qc(l)&&(t.views.delete(i),l.query._queryParams.loadsAllData()||r.push(l.query)))}return a&&!on(t)&&r.push(new(ME())(e._repo,e._path)),{removed:r,events:o}}function id(t){const e=[];for(const n of t.views.values())n.query._queryParams.loadsAllData()||e.push(n);return e}function Yt(t,e){let n=null;for(const s of t.views.values())n=n||NE(s,e);return n}function rd(t,e){if(e._queryParams.loadsAllData())return br(t);{const s=e._queryIdentifier;return t.views.get(s)}}function od(t,e){return rd(t,e)!=null}function on(t){return br(t)!=null}function br(t){for(const e of t.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Yi;function BE(t){I(!Yi,"__referenceConstructor has already been defined"),Yi=t}function UE(){return I(Yi,"Reference.ts has not been loaded"),Yi}let jE=1;class Yc{constructor(e){this.listenProvider_=e,this.syncPointTree_=new he(null),this.pendingWriteTree_=gE(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function ad(t,e,n,s,i){return rE(t.pendingWriteTree_,e,n,s,i),i?oi(t,new Nn(qf(),e,n)):[]}function gn(t,e,n=!1){const s=oE(t.pendingWriteTree_,e);if(aE(t.pendingWriteTree_,e)){let r=new he(null);return s.snap!=null?r=r.set(ne(),!0):He(s.children,o=>{r=r.set(new le(o),!0)}),oi(t,new Hi(s.path,r,n))}else return[]}function ri(t,e,n){return oi(t,new Nn(Da(),e,n))}function VE(t,e,n){const s=he.fromObject(n);return oi(t,new Gs(Da(),e,s))}function HE(t,e){return oi(t,new Ws(Da(),e))}function WE(t,e,n){const s=ja(t,n);if(s){const i=Va(s),r=i.path,o=i.queryId,a=Le(r,e),l=new Ws(Ma(o),a);return Ha(t,r,l)}else return[]}function ld(t,e,n,s,i=!1){const r=e._path,o=t.syncPointTree_.get(r);let a=[];if(o&&(e._queryIdentifier==="default"||od(o,e))){const l=$E(o,e,n,s);LE(o)&&(t.syncPointTree_=t.syncPointTree_.remove(r));const c=l.removed;if(a=l.events,!i){const h=c.findIndex(f=>f._queryParams.loadsAllData())!==-1,u=t.syncPointTree_.findOnPath(r,(f,m)=>on(m));if(h&&!u){const f=t.syncPointTree_.subtree(r);if(!f.isEmpty()){const m=zE(f);for(let g=0;g<m.length;++g){const S=m[g],k=S.query,O=fd(t,S);t.listenProvider_.startListening(xs(k),qs(t,k),O.hashFn,O.onComplete)}}}!u&&c.length>0&&!s&&(h?t.listenProvider_.stopListening(xs(e),null):c.forEach(f=>{const m=t.queryToTagMap.get(wr(f));t.listenProvider_.stopListening(xs(f),m)}))}YE(t,c)}return a}function cd(t,e,n,s){const i=ja(t,s);if(i!=null){const r=Va(i),o=r.path,a=r.queryId,l=Le(o,e),c=new Nn(Ma(a),l,n);return Ha(t,o,c)}else return[]}function GE(t,e,n,s){const i=ja(t,s);if(i){const r=Va(i),o=r.path,a=r.queryId,l=Le(o,e),c=he.fromObject(n),h=new Gs(Ma(a),l,c);return Ha(t,o,h)}else return[]}function qE(t,e,n,s=!1){const i=e._path;let r=null,o=!1;t.syncPointTree_.foreachOnPath(i,(f,m)=>{const g=Le(f,i);r=r||Yt(m,g),o=o||on(m)});let a=t.syncPointTree_.get(i);a?(o=o||on(a),r=r||Yt(a,ne())):(a=new nd,t.syncPointTree_=t.syncPointTree_.set(i,a));let l;r!=null?l=!0:(l=!1,r=U.EMPTY_NODE,t.syncPointTree_.subtree(i).foreachChild((m,g)=>{const S=Yt(g,ne());S&&(r=r.updateImmediateChild(m,S))}));const c=od(a,e);if(!c&&!e._queryParams.loadsAllData()){const f=wr(e);I(!t.queryToTagMap.has(f),"View does not exist, but we have a tag");const m=QE();t.queryToTagMap.set(f,m),t.tagToQueryMap.set(m,f)}const h=vr(t.pendingWriteTree_,i);let u=FE(a,e,n,h,r,l);if(!c&&!o&&!s){const f=rd(a,e);u=u.concat(JE(t,e,f))}return u}function Ua(t,e,n){const i=t.pendingWriteTree_,r=t.syncPointTree_.findOnPath(e,(o,a)=>{const l=Le(o,e),c=Yt(a,l);if(c)return c});return Qf(i,e,r,n,!0)}function KE(t,e){const n=e._path;let s=null;t.syncPointTree_.foreachOnPath(n,(c,h)=>{const u=Le(c,n);s=s||Yt(h,u)});let i=t.syncPointTree_.get(n);i?s=s||Yt(i,ne()):(i=new nd,t.syncPointTree_=t.syncPointTree_.set(n,i));const r=s!=null,o=r?new rn(s,!0,!1):null,a=vr(t.pendingWriteTree_,e._path),l=sd(i,e,a,r?o.getNode():U.EMPTY_NODE,r);return PE(l)}function oi(t,e){return ud(e,t.syncPointTree_,null,vr(t.pendingWriteTree_,ne()))}function ud(t,e,n,s){if(X(t.path))return hd(t,e,n,s);{const i=e.get(ne());n==null&&i!=null&&(n=Yt(i,ne()));let r=[];const o=ee(t.path),a=t.operationForChild(o),l=e.children.get(o);if(l&&a){const c=n?n.getImmediateChild(o):null,h=Jf(s,o);r=r.concat(ud(a,l,c,h))}return i&&(r=r.concat(Ba(i,t,s,n))),r}}function hd(t,e,n,s){const i=e.get(ne());n==null&&i!=null&&(n=Yt(i,ne()));let r=[];return e.children.inorderTraversal((o,a)=>{const l=n?n.getImmediateChild(o):null,c=Jf(s,o),h=t.operationForChild(o);h&&(r=r.concat(hd(h,a,l,c)))}),i&&(r=r.concat(Ba(i,t,s,n))),r}function fd(t,e){const n=e.query,s=qs(t,n);return{hashFn:()=>(xE(e)||U.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return s?WE(t,n._path,s):HE(t,n._path);{const r=qb(i,n);return ld(t,n,null,r)}}}}function qs(t,e){const n=wr(e);return t.queryToTagMap.get(n)}function wr(t){return t._path.toString()+"$"+t._queryIdentifier}function ja(t,e){return t.tagToQueryMap.get(e)}function Va(t){const e=t.indexOf("$");return I(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new le(t.substr(0,e))}}function Ha(t,e,n){const s=t.syncPointTree_.get(e);I(s,"Missing sync point for query tag that we're tracking");const i=vr(t.pendingWriteTree_,e);return Ba(s,n,i,null)}function zE(t){return t.fold((e,n,s)=>{if(n&&on(n))return[br(n)];{let i=[];return n&&(i=id(n)),He(s,(r,o)=>{i=i.concat(o)}),i}})}function xs(t){return t._queryParams.loadsAllData()&&!t._queryParams.isDefault()?new(UE())(t._repo,t._path):t}function YE(t,e){for(let n=0;n<e.length;++n){const s=e[n];if(!s._queryParams.loadsAllData()){const i=wr(s),r=t.queryToTagMap.get(i);t.queryToTagMap.delete(i),t.tagToQueryMap.delete(r)}}}function QE(){return jE++}function JE(t,e,n){const s=e._path,i=qs(t,e),r=fd(t,n),o=t.listenProvider_.startListening(xs(e),i,r.hashFn,r.onComplete),a=t.syncPointTree_.subtree(s);if(i)I(!on(a.value),"If we're adding a query, it shouldn't be shadowed");else{const l=a.fold((c,h,u)=>{if(!X(c)&&h&&on(h))return[br(h).query];{let f=[];return h&&(f=f.concat(id(h).map(m=>m.query))),He(u,(m,g)=>{f=f.concat(g)}),f}});for(let c=0;c<l.length;++c){const h=l[c];t.listenProvider_.stopListening(xs(h),qs(t,h))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rC=/[\[\].#$\/\u0000-\u001F\u007F]/,oC=/[\[\].#$\u0000-\u001F\u007F]/,Yr=10*1024*1024,_d=function(t){return typeof t=="string"&&t.length!==0&&!rC.test(t)},yd=function(t){return typeof t=="string"&&t.length!==0&&!oC.test(t)},aC=function(t){return t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),yd(t)},vd=function(t,e,n,s){s&&e===void 0||Ya(Ca(t,"value"),e,n)},Ya=function(t,e,n){const s=n instanceof le?new Sw(n,t):n;if(e===void 0)throw new Error(t+"contains undefined "+pn(s));if(typeof e=="function")throw new Error(t+"contains a function "+pn(s)+" with contents = "+e.toString());if(df(e))throw new Error(t+"contains "+e.toString()+" "+pn(s));if(typeof e=="string"&&e.length>Yr/3&&gr(e)>Yr)throw new Error(t+"contains a string greater than "+Yr+" utf8 bytes "+pn(s)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let i=!1,r=!1;if(He(e,(o,a)=>{if(o===".value")i=!0;else if(o!==".priority"&&o!==".sv"&&(r=!0,!_d(o)))throw new Error(t+" contains an invalid key ("+o+") "+pn(s)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);Tw(s,o),Ya(t,a,s),Rw(s)}),i&&r)throw new Error(t+' contains ".value" child '+pn(s)+" in addition to actual children.")}},bd=function(t,e,n,s){if(!(s&&n===void 0)&&!yd(n))throw new Error(Ca(t,e)+'was an invalid path = "'+n+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},lC=function(t,e,n,s){n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),bd(t,e,n,s)},Qa=function(t,e){if(ee(e)===".info")throw new Error(t+" failed = Can't modify data under /.info/")},cC=function(t,e){const n=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!_d(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||n.length!==0&&!aC(n))throw new Error(Ca(t,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class uC{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function wd(t,e){let n=null;for(let s=0;s<e.length;s++){const i=e[s],r=i.getPath();n!==null&&!Ff(r,n.path)&&(t.eventLists_.push(n),n=null),n===null&&(n={events:[],path:r}),n.events.push(i)}n&&t.eventLists_.push(n)}function yt(t,e,n){wd(t,n),hC(t,s=>ot(s,e)||ot(e,s))}function hC(t,e){t.recursionDepth_++;let n=!0;for(let s=0;s<t.eventLists_.length;s++){const i=t.eventLists_[s];if(i){const r=i.path;e(r)?(fC(t.eventLists_[s]),t.eventLists_[s]=null):n=!1}}n&&(t.eventLists_=[]),t.recursionDepth_--}function fC(t){for(let e=0;e<t.events.length;e++){const n=t.events[e];if(n!==null){t.events[e]=null;const s=n.getEventRunner();Rn&&Pe("event: "+n.toString()),rs(s)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dC="repo_interrupt",pC=25;class mC{constructor(e,n,s,i){this.repoInfo_=e,this.forceRestClient_=n,this.authTokenProvider_=s,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new uC,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Vi(),this.transactionQueueTree_=new Ka,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function gC(t,e,n){if(t.stats_=Aa(t.repoInfo_),t.forceRestClient_||Qb())t.server_=new ji(t.repoInfo_,(s,i,r,o)=>{Jc(t,s,i,r,o)},t.authTokenProvider_,t.appCheckProvider_),setTimeout(()=>Xc(t,!0),0);else{if(typeof n<"u"&&n!==null){if(typeof n!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{ye(n)}catch(s){throw new Error("Invalid authOverride provided: "+s)}}t.persistentConnection_=new Rt(t.repoInfo_,e,(s,i,r,o)=>{Jc(t,s,i,r,o)},s=>{Xc(t,s)},s=>{_C(t,s)},t.authTokenProvider_,t.appCheckProvider_,n),t.server_=t.persistentConnection_}t.authTokenProvider_.addTokenChangeListener(s=>{t.server_.refreshAuthToken(s)}),t.appCheckProvider_.addTokenChangeListener(s=>{t.server_.refreshAppCheckToken(s.token)}),t.statsReporter_=tw(t.repoInfo_,()=>new Zw(t.stats_,t.server_)),t.infoData_=new zw,t.infoSyncTree_=new Yc({startListening:(s,i,r,o)=>{let a=[];const l=t.infoData_.getNode(s._path);return l.isEmpty()||(a=ri(t.infoSyncTree_,s._path,l),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),Xa(t,"connected",!1),t.serverSyncTree_=new Yc({startListening:(s,i,r,o)=>(t.server_.listen(s,r,i,(a,l)=>{const c=o(a,l);yt(t.eventQueue_,s._path,c)}),[]),stopListening:(s,i)=>{t.server_.unlisten(s,i)}})}function Ed(t){const n=t.infoData_.getNode(new le(".info/serverTimeOffset")).val()||0;return new Date().getTime()+n}function Ja(t){return XE({timestamp:Ed(t)})}function Jc(t,e,n,s,i){t.dataUpdateCount++;const r=new le(e);n=t.interceptServerDataCallback_?t.interceptServerDataCallback_(e,n):n;let o=[];if(i)if(s){const l=Mi(n,c=>Ie(c));o=GE(t.serverSyncTree_,r,l,i)}else{const l=Ie(n);o=cd(t.serverSyncTree_,r,l,i)}else if(s){const l=Mi(n,c=>Ie(c));o=VE(t.serverSyncTree_,r,l)}else{const l=Ie(n);o=ri(t.serverSyncTree_,r,l)}let a=r;o.length>0&&(a=Ir(t,r)),yt(t.eventQueue_,a,o)}function Xc(t,e){Xa(t,"connected",e),e===!1&&bC(t)}function _C(t,e){He(e,(n,s)=>{Xa(t,n,s)})}function Xa(t,e,n){const s=new le("/.info/"+e),i=Ie(n);t.infoData_.updateSnapshot(s,i);const r=ri(t.infoSyncTree_,s,i);yt(t.eventQueue_,s,r)}function Cd(t){return t.nextWriteId_++}function yC(t,e,n){const s=KE(t.serverSyncTree_,e);return s!=null?Promise.resolve(s):t.server_.get(e).then(i=>{const r=Ie(i).withIndex(e._queryParams.getIndex());qE(t.serverSyncTree_,e,n,!0);let o;if(e._queryParams.loadsAllData())o=ri(t.serverSyncTree_,e._path,r);else{const a=qs(t.serverSyncTree_,e);o=cd(t.serverSyncTree_,e._path,r,a)}return yt(t.eventQueue_,e._path,o),ld(t.serverSyncTree_,e,n,null,!0),r},i=>(Cr(t,"get for query "+ye(e)+" failed: "+i),Promise.reject(new Error(i))))}function vC(t,e,n,s,i){Cr(t,"set",{path:e.toString(),value:n,priority:s});const r=Ja(t),o=Ie(n,s),a=Ua(t.serverSyncTree_,e),l=dd(o,a,r),c=Cd(t),h=ad(t.serverSyncTree_,e,l,c,!0);wd(t.eventQueue_,h),t.server_.put(e.toString(),o.val(!0),(f,m)=>{const g=f==="ok";g||je("set at "+e+" failed: "+f);const S=gn(t.serverSyncTree_,c,!g);yt(t.eventQueue_,e,S),EC(t,i,f,m)});const u=Ad(t,e);Ir(t,u),yt(t.eventQueue_,u,[])}function bC(t){Cr(t,"onDisconnectEvents");const e=Ja(t),n=Vi();jo(t.onDisconnect_,ne(),(i,r)=>{const o=tC(i,r,t.serverSyncTree_,e);Gf(n,i,o)});let s=[];jo(n,ne(),(i,r)=>{s=s.concat(ri(t.serverSyncTree_,i,r));const o=Ad(t,i);Ir(t,o)}),t.onDisconnect_=Vi(),yt(t.eventQueue_,ne(),s)}function wC(t){t.persistentConnection_&&t.persistentConnection_.interrupt(dC)}function Cr(t,...e){let n="";t.persistentConnection_&&(n=t.persistentConnection_.id+":"),Pe(n,...e)}function EC(t,e,n,s){e&&rs(()=>{if(n==="ok")e(null);else{const i=(n||"error").toUpperCase();let r=i;s&&(r+=": "+s);const o=new Error(r);o.code=i,e(o)}})}function Id(t,e,n){return Ua(t.serverSyncTree_,e,n)||U.EMPTY_NODE}function Za(t,e=t.transactionQueueTree_){if(e||Sr(t,e),os(e)){const n=Td(t,e);I(n.length>0,"Sending zero length transaction queue"),n.every(i=>i.status===0)&&CC(t,ai(e),n)}else md(e)&&Er(e,n=>{Za(t,n)})}function CC(t,e,n){const s=n.map(c=>c.currentWriteId),i=Id(t,e,s);let r=i;const o=i.hash();for(let c=0;c<n.length;c++){const h=n[c];I(h.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),h.status=1,h.retryCount++;const u=Le(e,h.path);r=r.updateChild(u,h.currentOutputSnapshotRaw)}const a=r.val(!0),l=e;t.server_.put(l.toString(),a,c=>{Cr(t,"transaction put response",{path:l.toString(),status:c});let h=[];if(c==="ok"){const u=[];for(let f=0;f<n.length;f++)n[f].status=2,h=h.concat(gn(t.serverSyncTree_,n[f].currentWriteId)),n[f].onComplete&&u.push(()=>n[f].onComplete(null,!0,n[f].currentOutputSnapshotResolved)),n[f].unwatcher();Sr(t,za(t.transactionQueueTree_,e)),Za(t,t.transactionQueueTree_),yt(t.eventQueue_,e,h);for(let f=0;f<u.length;f++)rs(u[f])}else{if(c==="datastale")for(let u=0;u<n.length;u++)n[u].status===3?n[u].status=4:n[u].status=0;else{je("transaction at "+l.toString()+" failed: "+c);for(let u=0;u<n.length;u++)n[u].status=4,n[u].abortReason=c}Ir(t,e)}},o)}function Ir(t,e){const n=Sd(t,e),s=ai(n),i=Td(t,n);return IC(t,i,s),s}function IC(t,e,n){if(e.length===0)return;const s=[];let i=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const l=e[a],c=Le(n,l.path);let h=!1,u;if(I(c!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),l.status===4)h=!0,u=l.abortReason,i=i.concat(gn(t.serverSyncTree_,l.currentWriteId,!0));else if(l.status===0)if(l.retryCount>=pC)h=!0,u="maxretry",i=i.concat(gn(t.serverSyncTree_,l.currentWriteId,!0));else{const f=Id(t,l.path,o);l.currentInputSnapshot=f;const m=e[a].update(f.val());if(m!==void 0){Ya("transaction failed: Data returned ",m,l.path);let g=Ie(m);typeof m=="object"&&m!=null&&Ot(m,".priority")||(g=g.updatePriority(f.getPriority()));const k=l.currentWriteId,O=Ja(t),M=dd(g,f,O);l.currentOutputSnapshotRaw=g,l.currentOutputSnapshotResolved=M,l.currentWriteId=Cd(t),o.splice(o.indexOf(k),1),i=i.concat(ad(t.serverSyncTree_,l.path,M,l.currentWriteId,l.applyLocally)),i=i.concat(gn(t.serverSyncTree_,k,!0))}else h=!0,u="nodata",i=i.concat(gn(t.serverSyncTree_,l.currentWriteId,!0))}yt(t.eventQueue_,n,i),i=[],h&&(e[a].status=2,function(f){setTimeout(f,Math.floor(0))}(e[a].unwatcher),e[a].onComplete&&(u==="nodata"?s.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):s.push(()=>e[a].onComplete(new Error(u),!1,null))))}Sr(t,t.transactionQueueTree_);for(let a=0;a<s.length;a++)rs(s[a]);Za(t,t.transactionQueueTree_)}function Sd(t,e){let n,s=t.transactionQueueTree_;for(n=ee(e);n!==null&&os(s)===void 0;)s=za(s,n),e=ue(e),n=ee(e);return s}function Td(t,e){const n=[];return Rd(t,e,n),n.sort((s,i)=>s.order-i.order),n}function Rd(t,e,n){const s=os(e);if(s)for(let i=0;i<s.length;i++)n.push(s[i]);Er(e,i=>{Rd(t,i,n)})}function Sr(t,e){const n=os(e);if(n){let s=0;for(let i=0;i<n.length;i++)n[i].status!==2&&(n[s]=n[i],s++);n.length=s,pd(e,n.length>0?n:void 0)}Er(e,s=>{Sr(t,s)})}function Ad(t,e){const n=ai(Sd(t,e)),s=za(t.transactionQueueTree_,e);return sC(s,i=>{Qr(t,i)}),Qr(t,s),gd(s,i=>{Qr(t,i)}),n}function Qr(t,e){const n=os(e);if(n){const s=[];let i=[],r=-1;for(let o=0;o<n.length;o++)n[o].status===3||(n[o].status===1?(I(r===o-1,"All SENT items should be at beginning of queue."),r=o,n[o].status=3,n[o].abortReason="set"):(I(n[o].status===0,"Unexpected transaction status in abort"),n[o].unwatcher(),i=i.concat(gn(t.serverSyncTree_,n[o].currentWriteId,!0)),n[o].onComplete&&s.push(n[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?pd(e,void 0):n.length=r+1,yt(t.eventQueue_,ai(e),i);for(let o=0;o<s.length;o++)rs(s[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */_t(tI,nI,"app");const sI=(t,e)=>e.some(n=>t instanceof n);let tu,nu;function iI(){return tu||(tu=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function rI(){return nu||(nu=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const Pd=new WeakMap,zo=new WeakMap,Nd=new WeakMap,Jr=new WeakMap,sl=new WeakMap;function oI(t){const e=new Promise((n,s)=>{const i=()=>{t.removeEventListener("success",r),t.removeEventListener("error",o)},r=()=>{n(Qt(t.result)),i()},o=()=>{s(t.error),i()};t.addEventListener("success",r),t.addEventListener("error",o)});return e.then(n=>{n instanceof IDBCursor&&Pd.set(n,t)}).catch(()=>{}),sl.set(e,t),e}function aI(t){if(zo.has(t))return;const e=new Promise((n,s)=>{const i=()=>{t.removeEventListener("complete",r),t.removeEventListener("error",o),t.removeEventListener("abort",o)},r=()=>{n(),i()},o=()=>{s(t.error||new DOMException("AbortError","AbortError")),i()};t.addEventListener("complete",r),t.addEventListener("error",o),t.addEventListener("abort",o)});zo.set(t,e)}let Yo={get(t,e,n){if(t instanceof IDBTransaction){if(e==="done")return zo.get(t);if(e==="objectStoreNames")return t.objectStoreNames||Nd.get(t);if(e==="store")return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return Qt(t[e])},set(t,e,n){return t[e]=n,!0},has(t,e){return t instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in t}};function lI(t){Yo=t(Yo)}function cI(t){return t===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...n){const s=t.call(Xr(this),e,...n);return Nd.set(s,e.sort?e.sort():[e]),Qt(s)}:rI().includes(t)?function(...e){return t.apply(Xr(this),e),Qt(Pd.get(this))}:function(...e){return Qt(t.apply(Xr(this),e))}}function uI(t){return typeof t=="function"?cI(t):(t instanceof IDBTransaction&&aI(t),sI(t,iI())?new Proxy(t,Yo):t)}function Qt(t){if(t instanceof IDBRequest)return oI(t);if(Jr.has(t))return Jr.get(t);const e=uI(t);return e!==t&&(Jr.set(t,e),sl.set(e,t)),e}const Xr=t=>sl.get(t);function hI(t,e,{blocked:n,upgrade:s,blocking:i,terminated:r}={}){const o=indexedDB.open(t,e),a=Qt(o);return s&&o.addEventListener("upgradeneeded",l=>{s(Qt(o.result),l.oldVersion,l.newVersion,Qt(o.transaction))}),n&&o.addEventListener("blocked",()=>n()),a.then(l=>{r&&l.addEventListener("close",()=>r()),i&&l.addEventListener("versionchange",()=>i())}).catch(()=>{}),a}const fI=["get","getKey","getAll","getAllKeys","count"],dI=["put","add","delete","clear"],Zr=new Map;function su(t,e){if(!(t instanceof IDBDatabase&&!(e in t)&&typeof e=="string"))return;if(Zr.get(e))return Zr.get(e);const n=e.replace(/FromIndex$/,""),s=e!==n,i=dI.includes(n);if(!(n in(s?IDBIndex:IDBObjectStore).prototype)||!(i||fI.includes(n)))return;const r=async function(o,...a){const l=this.transaction(o,i?"readwrite":"readonly");let c=l.store;return s&&(c=c.index(a.shift())),(await Promise.all([c[n](...a),i&&l.done]))[0]};return Zr.set(e,r),r}lI(t=>({...t,get:(e,n,s)=>su(e,n)||t.get(e,n,s),has:(e,n)=>!!su(e,n)||t.has(e,n)}));const Od="@firebase/installations",il="0.6.4";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kd=1e4,Dd=`w:${il}`,Md="FIS_v2",pI="https://firebaseinstallations.googleapis.com/v1",mI=60*60*1e3,gI="installations",_I="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yI={"missing-app-config-values":'Missing App configuration value: "{$valueName}"',"not-registered":"Firebase Installation is not registered.","installation-not-found":"Firebase Installation not found.","request-failed":'{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',"app-offline":"Could not process request. Application offline.","delete-pending-registration":"Can't delete installation while there is a pending registration request."},kn=new mr(gI,_I,yI);function Ld(t){return t instanceof Mn&&t.code.includes("request-failed")}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fd({projectId:t}){return`${pI}/projects/${t}/installations`}function $d(t){return{token:t.token,requestStatus:2,expiresIn:bI(t.expiresIn),creationTime:Date.now()}}async function Bd(t,e){const s=(await e.json()).error;return kn.create("request-failed",{requestName:t,serverCode:s.code,serverMessage:s.message,serverStatus:s.status})}function Ud({apiKey:t}){return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":t})}function vI(t,{refreshToken:e}){const n=Ud(t);return n.append("Authorization",wI(e)),n}async function jd(t){const e=await t();return e.status>=500&&e.status<600?t():e}function bI(t){return Number(t.replace("s","000"))}function wI(t){return`${Md} ${t}`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function EI({appConfig:t,heartbeatServiceProvider:e},{fid:n}){const s=Fd(t),i=Ud(t),r=e.getImmediate({optional:!0});if(r){const c=await r.getHeartbeatsHeader();c&&i.append("x-firebase-client",c)}const o={fid:n,authVersion:Md,appId:t.appId,sdkVersion:Dd},a={method:"POST",headers:i,body:JSON.stringify(o)},l=await jd(()=>fetch(s,a));if(l.ok){const c=await l.json();return{fid:c.fid||n,registrationStatus:2,refreshToken:c.refreshToken,authToken:$d(c.authToken)}}else throw await Bd("Create Installation",l)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hd=new Map;function Wd(t,e){const n=Rr(t);Gd(n,e),RI(n,e)}function Gd(t,e){const n=Hd.get(t);if(n)for(const s of n)s(e)}function RI(t,e){const n=AI();n&&n.postMessage({key:t,fid:e}),xI()}let _n=null;function AI(){return!_n&&"BroadcastChannel"in self&&(_n=new BroadcastChannel("[Firebase] FID Change"),_n.onmessage=t=>{Gd(t.data.key,t.data.fid)}),_n}function xI(){Hd.size===0&&_n&&(_n.close(),_n=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function FI({appConfig:t,heartbeatServiceProvider:e},n){const s=$I(t,n),i=vI(t,n),r=e.getImmediate({optional:!0});if(r){const c=await r.getHeartbeatsHeader();c&&i.append("x-firebase-client",c)}const o={installation:{sdkVersion:Dd,appId:t.appId}},a={method:"POST",headers:i,body:JSON.stringify(o)},l=await jd(()=>fetch(s,a));if(l.ok){const c=await l.json();return $d(c)}else throw await Bd("Generate Auth Token",l)}function $I(t,{fid:e}){return`${Fd(t)}/${e}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function al(t,e=!1){let n;const s=await Ar(t.appConfig,r=>{if(!zd(r))throw kn.create("not-registered");const o=r.authToken;if(!e&&jI(o))return r;if(o.requestStatus===1)return n=BI(t,e),r;{if(!navigator.onLine)throw kn.create("app-offline");const a=HI(r);return n=UI(t,a),a}});return n?await n:s.authToken}async function BI(t,e){let n=await ru(t.appConfig);for(;n.authToken.requestStatus===1;)await Vd(100),n=await ru(t.appConfig);const s=n.authToken;return s.requestStatus===0?al(t,e):s}function ru(t){return Ar(t,e=>{if(!zd(e))throw kn.create("not-registered");const n=e.authToken;return WI(n)?Object.assign(Object.assign({},e),{authToken:{requestStatus:0}}):e})}async function UI(t,e){try{const n=await FI(t,e),s=Object.assign(Object.assign({},e),{authToken:n});return await Qi(t.appConfig,s),n}catch(n){if(Ld(n)&&(n.customData.serverCode===401||n.customData.serverCode===404))await qd(t.appConfig);else{const s=Object.assign(Object.assign({},e),{authToken:{requestStatus:0}});await Qi(t.appConfig,s)}throw n}}function zd(t){return t!==void 0&&t.registrationStatus===2}function jI(t){return t.requestStatus===2&&!VI(t)}function VI(t){const e=Date.now();return e<t.creationTime||t.creationTime+t.expiresIn<e+mI}function HI(t){const e={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},t),{authToken:e})}function WI(t){return t.requestStatus===1&&t.requestTime+kd<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yd="installations",YI="installations-internal",QI=t=>{const e=t.getProvider("app").getImmediate(),n=zI(e),s=ti(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:s,_delete:()=>Promise.resolve()}},JI=t=>{const e=t.getProvider("app").getImmediate(),n=ti(e,Yd).getImmediate();return{getId:()=>GI(n),getToken:i=>qI(n,i)}};function XI(){nn(new At(Yd,QI,"PUBLIC")),nn(new At(YI,JI,"PRIVATE"))}XI();_t(Od,il);_t(Od,il,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dS=30,pS=1e3;class mS{constructor(e={},n=pS){this.throttleMetadata=e,this.intervalMillis=n}getThrottleMetadata(e){return this.throttleMetadata[e]}setThrottleMetadata(e,n){this.throttleMetadata[e]=n}deleteThrottleMetadata(e){delete this.throttleMetadata[e]}}const Jd=new mS;function gS(t){return new Headers({Accept:"application/json","x-goog-api-key":t})}async function _S(t){var e;const{appId:n,apiKey:s}=t,i={method:"GET",headers:gS(s)},r=nS.replace("{app-id}",n),o=await fetch(r,i);if(o.status!==200&&o.status!==304){let a="";try{const l=await o.json();!((e=l.error)===null||e===void 0)&&e.message&&(a=l.error.message)}catch{}throw qe.create("config-fetch-failed",{httpStatus:o.status,responseMessage:a})}return o.json()}async function yS(t,e=Jd,n){const{appId:s,apiKey:i,measurementId:r}=t.options;if(!s)throw qe.create("no-app-id");if(!i){if(r)return{measurementId:r,appId:s};throw qe.create("no-api-key")}const o=e.getThrottleMetadata(s)||{backoffCount:0,throttleEndTimeMillis:Date.now()},a=new wS;return setTimeout(async()=>{a.abort()},n!==void 0?n:tS),Xd({appId:s,apiKey:i,measurementId:r},o,a,e)}async function Xd(t,{throttleEndTimeMillis:e,backoffCount:n},s,i=Jd){var r;const{appId:o,measurementId:a}=t;try{await vS(s,e)}catch(l){if(a)return Ve.warn(`Timed out fetching this Firebase app's measurement ID from the server. Falling back to the measurement ID ${a} provided in the "measurementId" field in the local Firebase config. [${l==null?void 0:l.message}]`),{appId:o,measurementId:a};throw l}try{const l=await _S(t);return i.deleteThrottleMetadata(o),l}catch(l){const c=l;if(!bS(c)){if(i.deleteThrottleMetadata(o),a)return Ve.warn(`Failed to fetch this Firebase app's measurement ID from the server. Falling back to the measurement ID ${a} provided in the "measurementId" field in the local Firebase config. [${c==null?void 0:c.message}]`),{appId:o,measurementId:a};throw l}const h=Number((r=c==null?void 0:c.customData)===null||r===void 0?void 0:r.httpStatus)===503?fc(n,i.intervalMillis,dS):fc(n,i.intervalMillis),u={throttleEndTimeMillis:Date.now()+h,backoffCount:n+1};return i.setThrottleMetadata(o,u),Ve.debug(`Calling attemptFetch again in ${h} millis`),Xd(t,u,s,i)}}function vS(t,e){return new Promise((n,s)=>{const i=Math.max(e-Date.now(),0),r=setTimeout(n,i);t.addEventListener(()=>{clearTimeout(r),s(qe.create("fetch-throttle",{throttleEndTimeMillis:e}))})})}function bS(t){if(!(t instanceof Mn)||!t.customData)return!1;const e=Number(t.customData.httpStatus);return e===429||e===500||e===503||e===504}class wS{constructor(){this.listeners=[]}addEventListener(e){this.listeners.push(e)}abort(){this.listeners.forEach(e=>e())}}async function ES(t,e,n,s,i){if(i&&i.global){t("event",n,s);return}else{const r=await e,o=Object.assign(Object.assign({},s),{send_to:r});t("event",n,o)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
