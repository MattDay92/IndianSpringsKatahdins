 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rv(t){return Kh(void 0,t)}function Kh(t,e){if(!(e instanceof Object))return e;switch(e.constructor){case Date:const n=e;return new Date(n.getTime());case Object:t===void 0&&(t={});break;case Array:t=[];break;default:return e}for(const n in e)!e.hasOwnProperty(n)||!ov(n)||(t[n]=Kh(t[n],e[n]));return t}function ov(t){return t!=="__proto__"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ib={"no-app":"No Firebase App '{$appName}' has been created - call initializeApp() first","bad-app-name":"Illegal App name: '{$appName}","duplicate-app":"Firebase App named '{$appName}' already exists with different options or config","app-deleted":"Firebase App named '{$appName}' already deleted","no-options":"Need to provide options, when not being deployed to hosting via source.","invalid-app-argument":"firebase.{$appName}() takes either no argument or a Firebase App instance.","invalid-log-argument":"First argument to `onLog` must be null or a function.","idb-open":"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.","idb-get":"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.","idb-set":"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.","idb-delete":"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}."},qt=new mr("app","Firebase",Ib);/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tb=wb;function nf(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const s=Object.assign({name:Mo,automaticDataCollectionEnabled:!1},e),i=s.name;if(typeof i!="string"||!i)throw qt.create("bad-app-name",{appName:String(i)});if(n||(n=zh()),!n)throw qt.create("no-options");const r=Fi.get(i);if(r){if(Li(n,r.options)&&Li(s,r.config))return r;throw qt.create("duplicate-app",{appName:i})}const o=new kv(i);for(const l of Lo.values())o.addComponent(l);const a=new Sb(n,s,o);return Fi.set(i,a),a}function sf(t=Mo){const e=Fi.get(t);if(!e&&t===Mo&&zh())return nf();if(!e)throw qt.create("no-app",{appName:t});return e}function _t(t,e,n){var s;let i=(s=Eb[t])!==null&&s!==void 0?s:t;n&&(i+=`-${n}`);const r=i.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const a=[`Unable to register library "${i}" with version "${e}":`];r&&a.push(`library name "${i}" contains illegal characters (whitespace or "/")`),r&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),xn.warn(a.join(" "));return}nn(new At(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rb="firebase-heartbeat-database",Ab=1,$s="firebase-heartbeat-store";let Hr=null;function rf(){return Hr||(Hr=Kv(Rb,Ab,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore($s)}catch(n){console.warn(n)}}}}).catch(t=>{throw qt.create("idb-open",{originalErrorMessage:t.message})})),Hr}async function xb(t){try{return await(await rf()).transaction($s).objectStore($s).get(of(t))}catch(e){if(e instanceof Mn)xn.warn(e.message);else{const n=qt.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});xn.warn(n.message)}}}async function mc(t,e){try{const s=(await rf()).transaction($s,"readwrite");await s.objectStore($s).put(e,of(t)),await s.done}catch(n){if(n instanceof Mn)xn.warn(n.message);else{const s=qt.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});xn.warn(s.message)}}}function of(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qa{constructor(e="",n=null,s={children:{},childCount:0}){this.name=e,this.parent=n,this.node=s}}function za(t,e){let n=e instanceof le?e:new le(e),s=t,i=ee(n);for(;i!==null;){const r=Jn(s.node.children,i)||{children:{},childCount:0};s=new qa(i,s,r),n=ue(n),i=ee(n)}return s}function rs(t){return t.node.value}function hd(t,e){t.node.value=e,Ko(t)}function fd(t){return t.node.childCount>0}function nC(t){return rs(t)===void 0&&!fd(t)}function Er(t,e){He(t.node.children,(n,s)=>{e(new qa(n,t,s))})}function dd(t,e,n,s){n&&!s&&e(t),Er(t,i=>{dd(i,e,!0,s)}),n&&s&&e(t)}function sC(t,e,n){let s=n?t:t.parent;for(;s!==null;){if(e(s))return!0;s=s.parent}return!1}function ai(t){return new le(t.parent===null?t.name:ai(t.parent)+"/"+t.name)}function Ko(t){t.parent!==null&&iC(t.parent,t.name,t)}function iC(t,e,n){const s=nC(n),i=Ot(t.node.children,e);s&&i?(delete t.node.children[e],t.node.childCount--,Ko(t)):!s&&!i&&(t.node.children[e]=n.node,t.node.childCount++,Ko(t))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Za{constructor(e,n,s,i){this._repo=e,this._path=n,this._queryParams=s,this._orderByCalled=i}get key(){return X(this._path)?null:Nf(this._path)}get ref(){return new Dt(this._repo,this._path)}get _queryIdentifier(){const e=Lc(this._queryParams),n=Ta(e);return n==="{}"?"default":n}get _queryObject(){return Lc(this._queryParams)}isEqual(e){if(e=kt(e),!(e instanceof Za))return!1;const n=this._repo===e._repo,s=Df(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return n&&s&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+Iw(this._path)}}class Dt extends Za{constructor(e,n){super(e,n,new ka,!1)}get parent(){const e=kf(this._path);return e===null?null:new Dt(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class Ks{constructor(e,n,s){this._node=e,this.ref=n,this._index=s}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const n=new le(e),s=qs(this.ref,e);return new Ks(this._node.getChild(n),s,pe)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(s,i)=>e(new Ks(i,qs(this.ref,s),pe)))}hasChild(e){const n=new le(e);return!this._node.getChild(n).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function OC(t,e){return t=kt(t),t._checkNotDeleted("ref"),e!==void 0?qs(t._root,e):t._root}function qs(t,e){return t=kt(t),ee(t._path)===null?lC("child","path",e,!1):_d("child","path",e,!1),new Dt(t._repo,ve(t._path,e))}function kC(t,e){t=kt(t),yd("push",t._path),gd("push",e,t._path,!0);const n=bd(t._repo),s=AC(n),i=qs(t,s),r=qs(t,s);let o;return e!=null?o=Rd(r,e).then(()=>r):o=Promise.resolve(r),i.then=o.then.bind(o),i.catch=o.then.bind(o,void 0),i}function Rd(t,e){t=kt(t),yd("set",t._path),gd("set",e,t._path,!1);const n=new pr;return vC(t._repo,t._path,e,null,n.wrapCallback(()=>{})),n.promise}function LS(t){t=kt(t);const e=new NC(()=>{}),n=new el(e);return yC(t._repo,t,n).then(s=>new Ks(s,new Dt(t._repo,t._path),t._queryParams.getIndex()))}class el{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,n){const s=n._queryParams.getIndex();return new xC("value",this,new Ks(e.snapshotNode,new Dt(n._repo,n._path),s))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new PC(this,e,n):null}matches(e){return e instanceof el?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}DE(Dt);BE(Dt);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function VC(t){Lb(Tb),nn(new At("database",(e,{instanceIdentifier:n})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return FC(s,i,r,n)},"PUBLIC").setMultipleInstances(!0)),_t(vc,bc,t),_t(vc,bc,"esm2017")}Rt.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};Rt.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};VC();const Tr=t=>(Yu("data-v-4896eafd"),t=t(),Qu(),t),HC=Tr(()=>Be("div",{class:"footer-social"},[Be("h2",null,"Follow us on Facebook"),Be("a",{href:"https://www.facebook.com/profile.php?id=61555159784777",target:"_blank"},[Be("i",{class:"fa-brands fa-square-facebook"})])],-1)),WC={class:"subscribe-form"},GC=Tr(()=>Be("label",null,"Subscribe to the ISK Newsletter",-1)),KC=Tr(()=>Be("input",{class:"form-control",name:"signupemail",placeholder:"Enter Email Address"},null,-1)),qC=Tr(()=>Be("button",{class:"btn",type:"submit"},"Subscribe",-1)),zC=[GC,KC,qC],YC=t=>{t.preventDefault();const e=Ad(),n=t.target.signupemail.value,s=OC(e,"emails"),i=kC(s);Rd(i,{emailAddress:n}).then(()=>{alert("Successfully Subscribed to the ISK Newsletter!","success"),t.target.reset()},r=>{console.log("FAILED...",r.text)})},QC={__name:"Footer",setup(t){return document.getElementById("liveAlertPlaceholder"),(e,n)=>(Xs(),cr("footer",null,[HC,Be("div",WC,[Be("form",{name:"newsletter-form",onSubmit:s_(YC,["prevent"])},[...zC],32)])]))}},JC=ei(QC,[["__scopeId","data-v-4896eafd"],["__file","/Users/mattday/Desktop/Coding/IndianSpringsKatahdins/src/components/Footer.vue"]]),XC={__name:"HomeView",setup(t){return(e,n)=>(Xs(),cr(et,null,[Oe(zy),Be("main",null,[Oe(nv)]),Oe(JC)],64))}},ZC=ei(XC,[["__file","/Users/mattday/Desktop/Coding/IndianSpringsKatahdins/src/views/HomeView.vue"]]),eI=Ly({history:L_("/"),routes:[{path:"/",name:"home",component:ZC},{path:"/about",name:"about",component:()=>fs(()=>import("./AboutView-nmW7Ut69.js"),__vite__mapDeps([0,1]))},{path:"/recipes",name:"recipes",component:()=>fs(()=>import("./RecipeView-R84qbn08.js"),__vite__mapDeps([]))},{path:"/contact",name:"contact",component:()=>fs(()=>import("./ContactView-QRX8BzLR.js"),__vite__mapDeps([2,3]))},{path:"/menu",name:"menu",component:()=>fs(()=>import("./MenuView-Cx5bFQvc.js"),__vite__mapDeps([4,5]))},{path:"/admin12345",name:"admin",component:()=>fs(()=>import("./Admin-bDuHxOb6.js"),__vite__mapDeps([6,7]))}]});var tI="firebase",nI="10.7.2";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function rl(t,e=!1){let n;const s=await Ar(t.appConfig,r=>{if(!qd(r))throw kn.create("not-registered");const o=r.authToken;if(!e&&jI(o))return r;if(o.requestStatus===1)return n=BI(t,e),r;{if(!navigator.onLine)throw kn.create("app-offline");const a=HI(r);return n=UI(t,a),a}});return n?await n:s.authToken}async function BI(t,e){let n=await su(t.appConfig);for(;n.authToken.requestStatus===1;)await jd(100),n=await su(t.appConfig);const s=n.authToken;return s.requestStatus===0?rl(t,e):s}function su(t){return Ar(t,e=>{if(!qd(e))throw kn.create("not-registered");const n=e.authToken;return WI(n)?Object.assign(Object.assign({},e),{authToken:{requestStatus:0}}):e})}async function UI(t,e){try{const n=await FI(t,e),s=Object.assign(Object.assign({},e),{authToken:n});return await Qi(t.appConfig,s),n}catch(n){if(Md(n)&&(n.customData.serverCode===401||n.customData.serverCode===404))await Gd(t.appConfig);else{const s=Object.assign(Object.assign({},e),{authToken:{requestStatus:0}});await Qi(t.appConfig,s)}throw n}}function qd(t){return t!==void 0&&t.registrationStatus===2}function jI(t){return t.requestStatus===2&&!VI(t)}function VI(t){const e=Date.now();return e<t.creationTime||t.creationTime+t.expiresIn<e+mI}function HI(t){const e={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},t),{authToken:e})}function WI(t){return t.requestStatus===1&&t.requestTime+Od<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function KI(t,e=!1){const n=t;return await qI(n),(await rl(n,e)).token}async function qI(t){const{registrationPromise:e}=await il(t);e&&await e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zd="installations",YI="installations-internal",QI=t=>{const e=t.getProvider("app").getImmediate(),n=zI(e),s=ti(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:s,_delete:()=>Promise.resolve()}},JI=t=>{const e=t.getProvider("app").getImmediate(),n=ti(e,zd).getImmediate();return{getId:()=>GI(n),getToken:i=>KI(n,i)}};function XI(){nn(new At(zd,QI,"PUBLIC")),nn(new At(YI,JI,"PRIVATE"))}XI();_t(Nd,nl);_t(Nd,nl,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
